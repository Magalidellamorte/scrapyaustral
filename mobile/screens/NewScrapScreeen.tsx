  ...
  return (
    <>
                ...
                <View style={{ marginBottom: 20, marginRight: 20 }}>
                  <View
                    style={{
                      ...
                      height: 100,
                      backgroundColor:
                        category === value ? '#e2fef1' : '#f7f7f7',
                      borderWidth: 0,
                      borderRadius: 50,
                      shadowColor: category === value ? '#39ce67' : '#000',
                      shadowOffset: {
                        width: 0,
                        height: 4,
                      },
                      shadowOpacity: category === value ? 0.4 : 0.1,
                      shadowRadius: 4,
                      alignItems: 'center',
                      justifyContent: 'center',
                    }}
      ...
      >
        <Button
          type="secondary"
          disabled={!offertType || !category}
          onPress={() =>
            navigation.navigate('NewScrapSecond', {
              offertType,
              category,
            })
          }
