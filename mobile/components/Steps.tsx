...
function Steps({ type, step }: StepsProps) {
  const icons = {
    ...
    active_4: <Active4 style={{ transform: [{ scale: 0.7 }] }} />,
    ...
    <>
      <View style={styles.stepsGeneral}>
        ...
        <View
          style={[
            styles.step,
            step > 1 ? styles.stepActive : null,
            step === 1 ? styles.stepFocus : null,
          ]}
        >
          {icons[`${step > 1 ? 'active' : 'disabled'}_1`]}
        </View>
